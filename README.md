...
**Status:** security prototype, not a finished protection product. Do not use it to safeguard real secrets yet.

Read [the v1 specification](docs/v1-spec.md) and [the Linux prototype notes](prototype/linux/README.md) before running it.
